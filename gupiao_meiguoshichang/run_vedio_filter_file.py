...
def gupiao_meiguoshichang():
    #outputfile =  u"E:\\项目需求\\爬虫项目\\和硕爬虫\\tfidf\\"
    outputfile = u"D://workspace//python//classify_WeChat//gupiao_meiguoshichang//gptfidf"
    ...
    outputpath =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//gupiao_meiguoshichang.txt"
    outputpath2 =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//股票_美国市场去除文本.txt"
    # inputpath =u"../data/financeoutput1_final/股票.txt"
    # outputpath =u"../data/financeoutput1_final/股票_美国市场.txt"
    # outputpath2 =u"../data/financeoutput1_final/股票_美国市场去除文本.txt"

    #label = "股票"

    kword = {}
    keywordpath = u"D://workspace//python//classify_WeChat//gupiao_meiguoshichang//股票关键词.txt"
