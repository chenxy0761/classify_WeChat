...
def haiwaifangchan():
    ...
    outputfile = u"D://workspace//python//classify_WeChat//haiwaifangchan//hwfctfidf"
    # outputfile = u"hwfctfidf"
    ...
    #outputpath =u"E:\\项目需求\\JDPower\\分类\\4月份\\海外房产.txt"

    inputpath =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//financeoutput1_final.txt"
    outputpath =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//haiwaifangchan.txt"
    # inputpath =u"../data/financeoutput1_final/financeoutput1_final.txt"
    # outputpath =u"../data/financeoutput1_final/海外房产.txt"
