...
# parse commandline arguments 解析命令行参数
op = OptionParser()
op.add_option("--report",
              action="store_true", dest="print_report",
              help="Print a detailed classification report.")
#-m 为参数简写，—machine 为完整参数 store意思为将该参数存储， type为存储类型。
#  dest为存储至哪个变量，默认为完整参数名，help为帮助时显示的内容
...
#opts 是一个参数选项及其value的元组 ( ( '-f', 'hello'), ( '-t', '' ),
# ( '--format', '' ), ( '--directory-prefix', '/home' ) )
