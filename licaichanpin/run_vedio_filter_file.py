...
def licaichanpin():
    ...
    outputfile = u"D://workspace//python//classify_WeChat//licaichanpin//lccptfidf"
    # outputfile = u"lccptfidf"
    ...
    #outputpath =u"E:\\项目需求\\JDPower\\分类\\4月份\\理财产品.txt"
    # inputpath =u"../data/financeoutput1_final/financeoutput1_final.txt"
    # outputpath =u"../data/financeoutput1_final/理财产品.txt"
    inputpath =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//financeoutput1_final.txt"
    outputpath =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//licaichanpin.txt"
