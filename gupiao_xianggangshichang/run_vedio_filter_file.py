...
def gupiao_xianggangshichang():
    #outputfile =  u"E:\\项目需求\\爬虫项目\\和硕爬虫\\tfidf\\"
    outputfile = u"D://workspace//python//classify_WeChat//gupiao_xianggangshichang//gptfidf"
    ...
    outputpath =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//gupiao_xianggangshichang.txt"
    outputpath2 =u"D://workspace//python//classify_WeChat//data/financeoutput1_final//股票_港股去除文本.txt"
    # inputpath =u"../data/financeoutput1_final/股票.txt"
    # outputpath =u"../data/financeoutput1_final/股票_港股.txt"
    # outputpath2 =u"../data/financeoutput1_final/股票_港股去除文本.txt"

    #label = "股票"

    kword = {}
    keywordpath = u"D://workspace//python//classify_WeChat//gupiao_xianggangshichang//股票关键词.txt"
