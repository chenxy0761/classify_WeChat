...
def guoneikaifangjijin():
    #outputfile =  u"E:\\项目需求\\爬虫项目\\和硕爬虫\\tfidf\\"
    outputfile = u"D://workspace//python//classify_WeChat//guoneikaifangjijin//gnkfjjtfidf"
    # outputfile = u"gnkfjjtfidf"
    ...
    #outputpath =u"E:\\项目需求\\JDPower\\分类\\4月份\\国内开放式基金.txt"
    inputpath =u"D://workspace//python//classify_WeChat//data//financeoutput1_final//financeoutput1_final.txt"
    outputpath =u"D://workspace//python//classify_WeChat//data//financeoutput1_final//guoneikaifangjijin.txt"
